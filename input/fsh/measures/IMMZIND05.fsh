...
* url = "http://moh.catopiatz/ig/smart-immunizations-measles-tz/Measure/IMMZIND05"
* version = "0.1.0"
* status = #draft
* experimental = false
* date = "2023-10-05"
...
* library = "http://moh.catopiatz/ig/smart-immunizations-measles-tz/Library/IMMZINDMeasles"
